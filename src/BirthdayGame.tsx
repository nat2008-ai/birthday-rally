...
const GIFTS = [
  ...
  },
  {
    ...
    openedContent: (
      <>
        <p style={{fontSize: 62, lineHeight: 1.08, marginTop: 4}}>🎂📽️🍿🧋</p>
        <p style={{fontSize: 28, marginTop: 10, lineHeight: 1.14}}>Movie Date you &amp; me? <span style={{fontSize: 22}}>👀</span></p>
        <p style={{fontSize: 17, marginTop: 10, lineHeight: 1.45, color: '#444'}}>Coupon include 1 dessert treat! Redeem it early before the movie ends.</p>
